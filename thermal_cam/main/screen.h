...
#define SPI_CLK 26*1000*1000

#define SCREEN_PIN_MISO 25
#define SCREEN_PIN_MOSI 23
#define SCREEN_PIN_CLK  19
#define SCREEN_PIN_CS   17

#define SCREEN_PIN_DC   16
#define SCREEN_PIN_RST  18

//Send a command to the LCD
void lcd_cmd(spi_device_handle_t spi, const uint8_t cmd);
//Send data to the LCD
void lcd_data(spi_device_handle_t spi, const uint8_t *data, uint32_t len);
//Set the D/C line before a transfer occurs
